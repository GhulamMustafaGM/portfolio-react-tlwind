          ...
          >
            ...
            <div className="font-bold text-white md:px-5">
              <h1 className="text-7xl md:text-4xl" data-aos="slide-right">
                Hi , I am <b className="text-yellow-500">Ghulam Mustafa</b>
              </h1>
              <h1 className="text-4xl md:text-xl" data-aos="slide-left">
                FullStack Developer <b className="text-red-500">Fullstack Developer</b>
              </h1>
            </div>
          </div>
        </div>
          ...
          <div className="md:mx-5 mx-32 shadow-2xl bg-gray-50 -mt-20 rounded-lg hover:bg-gray-700 hover:text-white">
            ...
            <div className="grid md:grid-cols-1 grid-cols-3 p-5">
              <div>
                ...
                <p className="font-semibold mt-2">Javascript/Typscript</p>
                <p className="font-semibold mt-2">Node development</p>
              ...
              <div className="text-right">
                ...
                <p className="font-semibold mt-2">SQL</p>
